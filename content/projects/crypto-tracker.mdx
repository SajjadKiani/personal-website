---
  ...
  summary: A web-based application to track new tokens.
  image: /images/projects/crypto-trakcer-banner.png
  author: 'Sajad kiani'
...
[Github](https://github.com/SajjadKiani/token-tracker-view)